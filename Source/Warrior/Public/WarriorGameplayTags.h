...
namespace WarriorGameplayTags
{
	...
	WARRIOR_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTags_Roll);

	WARRIOR_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTags_MustBeHeld);
	WARRIOR_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTags_MustBeHeld_Block);
